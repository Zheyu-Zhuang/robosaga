...
from mimicgen_envs.models.robosuite.objects import BlenderObject, CoffeeMachinePodObject, CoffeeMachineObject, LongDrawerObject, CupObject
...
class CoffeePreparation(Coffee):
    ...
    def _get_mug_model(self):
        ...
        shapenet_scale = 1.0
        base_mjcf_path = os.path.join(mimicgen_envs.__path__[0], "models/robosuite/assets/shapenet_core/mugs")
